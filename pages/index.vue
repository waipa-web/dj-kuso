					...
					<Card class="h-full rounded-2xl shadow-xl border border-border bg-card">
						...
						<CardContent class="pt-2">
							<ol class="space-y-3 text-sm">
								...
								<li class="flex gap-3"><span class="text-primary font-black shrink-0">02</span><span>Pembayaran dilakukan di Awal dengan <span class="text-red-500 font-semibold">Full Payment.</span></span></li>
